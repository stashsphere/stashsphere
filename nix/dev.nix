...
let
  ...
  dexSettingsFile = pkgs.writeText "dex-dev-config.yaml" (
    builtins.toJSON (
  ...
  backendConfigFile = pkgs.writeText "backend-dev.json" (
    builtins.toJSON {
      ...
      domains = {
        allowed = [
          ...
          "http://localhost:${frontendNixPort}"
        ];
      ...
      processes = {
        ...
        frontend = {
          command = pkgs.writeShellScript "frontend-start" ''
            ...
            export PATH="$PATH:${pkgs.nodejs_22}/bin"
        ...
        frontend-nix = {
          command =
            ...
            pkgs.writeShellScript "frontend-nix-start" ''
              ...
              exec ${pkgs.serve}/bin/serve -s -l ${frontendNixPort}
            '';
          depends_on = {
            backend.condition = "process_healthy";
          };

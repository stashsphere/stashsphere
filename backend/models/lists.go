...
func (o *List) GetThings() ThingSlice {
	if o == nil {
		return nil
	}

	return o.R.GetThings()
}
...
func (o *List) GetPublicShares() PublicShareSlice {
	if o == nil {
		return nil
	}
...
func (r *listR) GetPublicShares() PublicShareSlice {
	if r == nil {
		return nil
	}
...
func (o *List) GetShares() ShareSlice {
	if o == nil {
		return nil
	}
...
func (o *List) PublicShares(mods ...qm.QueryMod) publicShareQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"public_shares\".\"list_id\"=?", o.ID),
	)
...
func (listL) LoadOwner(ctx context.Context, e boil.ContextExecutor, singular bool, maybeList any, mods queries.Applicator) error {
	var slice []*List
	var object *List
...
func (listL) LoadThings(ctx context.Context, e boil.ContextExecutor, singular bool, maybeList any, mods queries.Applicator) error {
	var slice []*List
	var object *List
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (listL) LoadPublicShares(ctx context.Context, e boil.ContextExecutor, singular bool, maybeList any, mods queries.Applicator) error {
	var slice []*List
	var object *List
	...
	query := NewQuery(
		...
		qm.WhereIn(`public_shares.list_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (listL) LoadShares(ctx context.Context, e boil.ContextExecutor, singular bool, maybeList any, mods queries.Applicator) error {
	var slice []*List
	var object *List
...
func (o *List) AddPublicShares(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*PublicShare) error {
	var err error
	for _, rel := range related {
		if insert {
...
// list replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.List's PublicShares accordingly.
// Replaces o.R.PublicShares with related.
// Sets related.R.List's PublicShares accordingly.
func (o *List) SetPublicShares(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*PublicShare) error {
	query := "update \"public_shares\" set \"list_id\" = null where \"list_id\" = $1"
	values := []any{o.ID}
	if boil.IsDebug(ctx) {
		writer := boil.DebugWriterFrom(ctx)
		fmt.Fprintln(writer, query)
...
// Sets related.R.List.
func (o *List) RemovePublicShares(ctx context.Context, exec boil.ContextExecutor, related ...*PublicShare) error {
	if len(related) == 0 {
		return nil
	}

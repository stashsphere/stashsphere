...
type thingR struct {
	...
	ImagesThings    ImagesThingSlice   `boil:"ImagesThings" json:"ImagesThings" toml:"ImagesThings" yaml:"ImagesThings"`
	...
	PublicShares    PublicShareSlice   `boil:"PublicShares" json:"PublicShares" toml:"PublicShares" yaml:"PublicShares"`
...
func (o *Thing) GetCartEntries() CartEntrySlice {
	if o == nil {
		return nil
	}
...
func (r *thingR) GetCartEntries() CartEntrySlice {
	if r == nil {
		return nil
	}
...
func (o *Thing) GetImagesThings() ImagesThingSlice {
	if o == nil {
		return nil
	}

	return o.R.GetImagesThings()
}

func (r *thingR) GetImagesThings() ImagesThingSlice {
	if r == nil {
		return nil
	}

	return r.ImagesThings
}

func (o *Thing) GetLists() ListSlice {
	if o == nil {
		return nil
	}
...
func (o *Thing) GetProperties() PropertySlice {
	if o == nil {
		return nil
	}

	return o.R.GetProperties()
}
...
func (o *Thing) GetPublicShares() PublicShareSlice {
	if o == nil {
		return nil
	}

	return o.R.GetPublicShares()
}

func (r *thingR) GetPublicShares() PublicShareSlice {
	if r == nil {
		return nil
	}

	return r.PublicShares
}

func (o *Thing) GetQuantityEntries() QuantityEntrySlice {
	if o == nil {
		return nil
	}

	return o.R.GetQuantityEntries()
}
...
func (o *Thing) GetShares() ShareSlice {
	if o == nil {
		return nil
	}

	return o.R.GetShares()
}
...
func (o *Thing) CartEntries(mods ...qm.QueryMod) cartEntryQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"cart_entries\".\"thing_id\"=?", o.ID),
	)

	return CartEntries(queryMods...)
}

// ImagesThings retrieves all the images_thing's ImagesThings with an executor.
func (o *Thing) ImagesThings(mods ...qm.QueryMod) imagesThingQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
...
// PublicShares retrieves all the public_share's PublicShares with an executor.
func (o *Thing) PublicShares(mods ...qm.QueryMod) publicShareQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"public_shares\".\"thing_id\"=?", o.ID),
	)
...
func (thingL) LoadOwner(ctx context.Context, e boil.ContextExecutor, singular bool, maybeThing any, mods queries.Applicator) error {
	var slice []*Thing
	var object *Thing
...
func (thingL) LoadCartEntries(ctx context.Context, e boil.ContextExecutor, singular bool, maybeThing any, mods queries.Applicator) error {
	var slice []*Thing
	var object *Thing
	...
	query := NewQuery(
		...
		qm.WhereIn(`cart_entries.thing_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// LoadImagesThings allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (thingL) LoadImagesThings(ctx context.Context, e boil.ContextExecutor, singular bool, maybeThing any, mods queries.Applicator) error {
	var slice []*Thing
	var object *Thing
	...
	query := NewQuery(
		qm.From(`images_things`),
		qm.WhereIn(`images_things.thing_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	results, err := query.QueryContext(ctx, e)
	if err != nil {
		return errors.Wrap(err, "failed to eager load images_things")
	}

	var resultSlice []*ImagesThing
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice images_things")
	}

	if err = results.Close(); err != nil {
		return errors.Wrap(err, "failed to close results in eager load on images_things")
	}
	if err = results.Err(); err != nil {
		return errors.Wrap(err, "error occurred during iteration of eager loaded relations for images_things")
	}
	...
	if singular {
		object.R.ImagesThings = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
				foreign.R = &imagesThingR{}
			}
			foreign.R.Thing = object
		}
		return nil
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.ThingID {
				local.R.ImagesThings = append(local.R.ImagesThings, foreign)
				if foreign.R == nil {
					foreign.R = &imagesThingR{}
				}
				foreign.R.Thing = local
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (thingL) LoadLists(ctx context.Context, e boil.ContextExecutor, singular bool, maybeThing any, mods queries.Applicator) error {
	var slice []*Thing
	var object *Thing
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (thingL) LoadProperties(ctx context.Context, e boil.ContextExecutor, singular bool, maybeThing any, mods queries.Applicator) error {
	var slice []*Thing
	var object *Thing
...
// LoadPublicShares allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (thingL) LoadPublicShares(ctx context.Context, e boil.ContextExecutor, singular bool, maybeThing any, mods queries.Applicator) error {
	var slice []*Thing
	var object *Thing
	...
	query := NewQuery(
		...
		qm.WhereIn(`public_shares.thing_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.PublicShares = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if queries.Equal(local.ID, foreign.ThingID) {
				local.R.PublicShares = append(local.R.PublicShares, foreign)
				if foreign.R == nil {
					foreign.R = &publicShareR{}
				}
				foreign.R.Thing = local
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (thingL) LoadQuantityEntries(ctx context.Context, e boil.ContextExecutor, singular bool, maybeThing any, mods queries.Applicator) error {
	var slice []*Thing
	var object *Thing
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (thingL) LoadShares(ctx context.Context, e boil.ContextExecutor, singular bool, maybeThing any, mods queries.Applicator) error {
	var slice []*Thing
	var object *Thing
...
func (o *Thing) AddCartEntries(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*CartEntry) error {
	var err error
...
// AddImagesThings adds the given related objects to the existing relationships
// of the thing, optionally inserting them as new records.
// Appends related to o.R.ImagesThings.
// Sets related.R.Thing appropriately.
func (o *Thing) AddImagesThings(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*ImagesThing) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.ThingID = o.ID
			...
			values := []any{o.ID, rel.ThingID, rel.ImageID}
	...
	if o.R == nil {
		o.R = &thingR{
			ImagesThings: related,
		}
	} else {
		o.R.ImagesThings = append(o.R.ImagesThings, related...)
	}
...
// AddPublicShares adds the given related objects to the existing relationships
// of the thing, optionally inserting them as new records.
// Appends related to o.R.PublicShares.
// Sets related.R.Thing appropriately.
func (o *Thing) AddPublicShares(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*PublicShare) error {
	var err error
	for _, rel := range related {
		if insert {
			queries.Assign(&rel.ThingID, o.ID)
			if err = rel.Insert(ctx, exec, boil.Infer()); err != nil {
				return errors.Wrap(err, "failed to insert into foreign table")
			}
		} else {
	...
	if o.R == nil {
		o.R = &thingR{
			PublicShares: related,
		}
	} else {
		o.R.PublicShares = append(o.R.PublicShares, related...)
	}
...
// SetPublicShares removes all previously related items of the
// thing replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.Thing's PublicShares accordingly.
// Replaces o.R.PublicShares with related.
// Sets related.R.Thing's PublicShares accordingly.
func (o *Thing) SetPublicShares(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*PublicShare) error {
	query := "update \"public_shares\" set \"thing_id\" = null where \"thing_id\" = $1"
	values := []any{o.ID}
	if boil.IsDebug(ctx) {
		writer := boil.DebugWriterFrom(ctx)
		fmt.Fprintln(writer, query)
	...
	if o.R != nil {
		for _, rel := range o.R.PublicShares {
			queries.SetScanner(&rel.ThingID, nil)
			if rel.R == nil {
				continue
			}
		...
		o.R.PublicShares = nil
	}

	return o.AddPublicShares(ctx, exec, insert, related...)
}

// RemovePublicShares relationships from objects passed in.
// Removes related items from R.PublicShares (uses pointer comparison, removal does not keep order)
// Sets related.R.Thing.
func (o *Thing) RemovePublicShares(ctx context.Context, exec boil.ContextExecutor, related ...*PublicShare) error {
	if len(related) == 0 {
		return nil
	}
	...
	for _, rel := range related {
		...
		if _, err = rel.Update(ctx, exec, boil.Whitelist("thing_id")); err != nil {
			return err
		}
	}
	if o.R == nil {
	...
	for _, rel := range related {
		for i, ri := range o.R.PublicShares {
			if rel != ri {
				continue
			}

			ln := len(o.R.PublicShares)
			if ln > 1 && i < ln-1 {
				o.R.PublicShares[i] = o.R.PublicShares[ln-1]
			}
			o.R.PublicShares = o.R.PublicShares[:ln-1]
			break
		}
	}

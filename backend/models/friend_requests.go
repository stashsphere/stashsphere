...
func (friendRequestL) LoadReceiver(ctx context.Context, e boil.ContextExecutor, singular bool, maybeFriendRequest any, mods queries.Applicator) error {
...
// loaded structs of the objects. This is for an N-1 relationship.
func (friendRequestL) LoadSender(ctx context.Context, e boil.ContextExecutor, singular bool, maybeFriendRequest any, mods queries.Applicator) error {
	var slice []*FriendRequest
	var object *FriendRequest
...
func (friendRequestL) LoadFriendships(ctx context.Context, e boil.ContextExecutor, singular bool, maybeFriendRequest any, mods queries.Applicator) error {
	var slice []*FriendRequest
	var object *FriendRequest

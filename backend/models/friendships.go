...
func (friendshipL) LoadFriend1(ctx context.Context, e boil.ContextExecutor, singular bool, maybeFriendship any, mods queries.Applicator) error {
...
// loaded structs of the objects. This is for an N-1 relationship.
func (friendshipL) LoadFriend2(ctx context.Context, e boil.ContextExecutor, singular bool, maybeFriendship any, mods queries.Applicator) error {
	var slice []*Friendship
	var object *Friendship
...
// loaded structs of the objects. This is for an N-1 relationship.
func (friendshipL) LoadFriendRequest(ctx context.Context, e boil.ContextExecutor, singular bool, maybeFriendship any, mods queries.Applicator) error {
	var slice []*Friendship
	var object *Friendship
...
func (o *Friendship) SetFriend1(ctx context.Context, exec boil.ContextExecutor, insert bool, related *User) error {
	...
	values := []any{related.ID, o.Friend1ID, o.Friend2ID}

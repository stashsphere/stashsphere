...
func (profileL) LoadImage(ctx context.Context, e boil.ContextExecutor, singular bool, maybeProfile any, mods queries.Applicator) error {
	var slice []*Profile
	var object *Profile
...
// loaded structs of the objects. This is for an N-1 relationship.
func (profileL) LoadUser(ctx context.Context, e boil.ContextExecutor, singular bool, maybeProfile any, mods queries.Applicator) error {
	var slice []*Profile
	var object *Profile

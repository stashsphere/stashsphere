...
func (imageL) LoadOwner(ctx context.Context, e boil.ContextExecutor, singular bool, maybeImage any, mods queries.Applicator) error {
	var slice []*Image
	var object *Image
...
func (imageL) LoadImagesThings(ctx context.Context, e boil.ContextExecutor, singular bool, maybeImage any, mods queries.Applicator) error {
	var slice []*Image
	var object *Image
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (imageL) LoadProfiles(ctx context.Context, e boil.ContextExecutor, singular bool, maybeImage any, mods queries.Applicator) error {
	var slice []*Image
	var object *Image

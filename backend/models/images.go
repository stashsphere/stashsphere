...
var ImageWhere = struct {
	...
	Mime:      whereHelperstring{field: "\"images\".\"mime\""},
...
func (o *Image) GetImagesThings() ImagesThingSlice {
	if o == nil {
		return nil
	}
...
func (r *imageR) GetImagesThings() ImagesThingSlice {
	if r == nil {
		return nil
	}
...
func (o *Image) GetProfiles() ProfileSlice {
	if o == nil {
		return nil
	}

	return o.R.GetProfiles()
}

func (r *imageR) GetProfiles() ProfileSlice {
	if r == nil {
		return nil
	}
...
func (o *Image) Owner(mods ...qm.QueryMod) userQuery {
...
func (o *Image) ImagesThings(mods ...qm.QueryMod) imagesThingQuery {
...
func (o *Image) Profiles(mods ...qm.QueryMod) profileQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"profiles\".\"image_id\"=?", o.ID),
	)
...
func (imageL) LoadOwner(ctx context.Context, e boil.ContextExecutor, singular bool, maybeImage interface{}, mods queries.Applicator) error {
	var slice []*Image
	var object *Image
	...
	if singular {
		...
		foreign.R.OwnerImages = append(foreign.R.OwnerImages, object)
		return nil
	}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if local.OwnerID == foreign.ID {
				...
				foreign.R.OwnerImages = append(foreign.R.OwnerImages, local)
				break
			}
		}
	}
...
func (imageL) LoadImagesThings(ctx context.Context, e boil.ContextExecutor, singular bool, maybeImage interface{}, mods queries.Applicator) error {
	var slice []*Image
	var object *Image
	...
	query := NewQuery(
		...
		qm.WhereIn(`images_things.image_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (imageL) LoadProfiles(ctx context.Context, e boil.ContextExecutor, singular bool, maybeImage interface{}, mods queries.Applicator) error {
	var slice []*Image
	var object *Image
	...
	query := NewQuery(
		qm.From(`profiles`),
		qm.WhereIn(`profiles.image_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// SetOwner of the image to the related item.
// Sets o.R.Owner to related.
// Adds o to related.R.OwnerImages.
func (o *Image) SetOwner(ctx context.Context, exec boil.ContextExecutor, insert bool, related *User) error {
	var err error
	if insert {
	...
	if related.R == nil {
		related.R = &userR{
			OwnerImages: ImageSlice{o},
		}
	} else {
		related.R.OwnerImages = append(related.R.OwnerImages, o)
	}
...
func (o *Image) AddImagesThings(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*ImagesThing) error {
	var err error
...
// Sets related.R.Image appropriately.
func (o *Image) AddProfiles(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Profile) error {
	var err error
	for _, rel := range related {
		if insert {
...
// Sets o.R.Image's Profiles accordingly.
// Replaces o.R.Profiles with related.
// Sets related.R.Image's Profiles accordingly.
func (o *Image) SetProfiles(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Profile) error {
	query := "update \"profiles\" set \"image_id\" = null where \"image_id\" = $1"
...
func (o *Image) RemoveProfiles(ctx context.Context, exec boil.ContextExecutor, related ...*Profile) error {
	if len(related) == 0 {
		return nil
	}
